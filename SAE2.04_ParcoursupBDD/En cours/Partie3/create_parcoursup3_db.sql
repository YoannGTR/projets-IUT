drop schema if exists parcoursup3 cascade;

create schema parcoursup3;
...
create table _admissions_generalites(
    ...
    effectif_total_admis                    integer         not null, -- admises incluses
    ...
    effectif_admis_meme_etablissement       integer, -- vide si sans objet, 0 si aucun admis meme etablissement
    effectif_admises_meme_etablissement     integer, -- vide si sans objet, 0 si aucun admis meme etablissement
    effectif_admis_meme_academie            integer     not null,
    effectif_admis_meme_academie_pcv        integer, -- Paris, Creteil, Versailles, idem ci-dessus    constraint _admissions_generalites_pk
    ...
    constraint _admissions_generalite_ck_admis_admises
        check (effectif_total_admis >= effectif_total_admises),
    constraint _admissions_generalite_ck_admis_admises_meme_etab
        check (effectif_admis_meme_etablissement >= effectif_admises_meme_etablissement)
);
...
create table _admissions_selon_type_neo_bac(
    ...
    effectif_candidat_neo_bac_boursiers_classes     integer, -- vide pour non neo-bac
    effectif_admis_neo_bac                          integer     not null,
    effectif_admis_neo_bac_avec_mention             integer, -- vide pour non neo-bac
